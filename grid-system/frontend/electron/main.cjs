...
const backendPath = app.isPackaged
    ...
    : path.join(__dirname, 'grid-system/backend');
...
function createWindow() {
    ...
    if (app.isPackaged) {
        // Sửa đường dẫn để trỏ đúng đến index.html trong app.asar
        const indexPath = path.join(__dirname, '..', 'dist', 'index.html');
        console.log('Loading index.html from:', indexPath); // Thêm log để debug
