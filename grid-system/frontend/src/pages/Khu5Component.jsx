...
const khu5Component = () => {
    const { khu5Config, switchKhu } = useSettings();
    ...
    const [rows, setRows] = useState(khu5Config.rows || 4);
    const [columns, setColumns] = useState(khu5Config.columns || 4);
    ...
    const handleCellChange = (rowIndex, colIndex, value) => {
        ...
        formattedValue.modelProcessCode = parts[0] || "test2"; // Mặc định là "test2"
        formattedValue.fromSystem = parts[1] || "MS_2"; // Mặc định là "MS_2"
        // Không thêm orderId ở đây, để GridDisplay tự động thêm
        formattedValue.taskOrderDetail = [
            {
                taskPath: parts[2] || "10000007", // Mặc định là "10000007"
                shelfNumber: parts[3] || "WAGON 7" // Mặc định là "WAGON 7"
            }
        ];
    ...
    const handleSaveData = () => {
        try {
            ...
            localStorage.setItem("khu5GridData", JSON.stringify(gridData));
    ...
    const handleLoadData = () => {
        try {
            const savedData = localStorage.getItem("khu5GridData");
            if (savedData) {
        ...
        <Container>
            ...
            <Card className="mb-4">
                <Card.Header className="bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 className="mb-0">KHU 5 - NHẬP DỮ LIỆU</h5>
                ...
                <Col md={6}>
                    <Card>
                        <Card.Header className="bg-light">
                            <h6 className="mb-0">Thống kê KHU 5</h6>
                        </Card.Header>
                        <Card.Body>
