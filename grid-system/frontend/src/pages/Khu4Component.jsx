...
const Khu4Component = () => {
    const { khu4Config, switchKhu } = useSettings();
    ...
    const [rows, setRows] = useState(khu4Config.rows || 4);
    const [columns, setColumns] = useState(khu4Config.columns || 4);
    ...
    const handleSaveData = () => {
        try {
            ...
            localStorage.setItem("khu4GridData", JSON.stringify(gridData));
        ...
        <Container>
            ...
            <Card className="mb-4">
                <Card.Header className="bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 className="mb-0">KHU 4 - NHẬP DỮ LIỆU</h5>
                ...
                <Col md={6}>
                    <Card>
                        <Card.Header className="bg-light">
                            <h6 className="mb-0">Thống kê KHU 4</h6>
                        </Card.Header>
                        <Card.Body>
