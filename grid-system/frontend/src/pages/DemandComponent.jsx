...
const DemandComponent = () => {
    const { DemandConfig, switchKhu } = useSettings();
    ...
    const [rows, setRows] = useState(DemandConfig.rows || 4);
    const [columns, setColumns] = useState(DemandConfig.columns || 4);
    ...
    const handleSaveData = () => {
        try {
            ...
            localStorage.setItem("DemandGridData", JSON.stringify(gridData));
    ...
    const handleLoadData = () => {
        try {
            const savedData = localStorage.getItem("DemandGridData");
            if (savedData) {
        ...
        <Container>
            ...
            <Card className="mb-4">
                <Card.Header className="bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 className="mb-0">KHU TRẢ HÀNG - NHẬP DỮ LIỆU</h5>
