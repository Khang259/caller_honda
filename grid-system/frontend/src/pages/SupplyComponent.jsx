...
const SupplyComponent = () => {
    const { SupplyConfig, switchKhu } = useSettings();
    ...
    const [rows, setRows] = useState(SupplyConfig.rows || 4);
    const [columns, setColumns] = useState(SupplyConfig.columns || 4);
    ...
    const handleCellChange = (rowIndex, colIndex, value) => {
        ...
        formattedValue.modelProcessCode = parts[0] || "1301"; // Mặc định là "1301"
        ...
        formattedValue.taskOrderDetail = [
            {
                ...
                shelfNumber: parts[3] || "" // Mặc định là "WAGON 7"
            }
        ];
    ...
    const handleSaveData = () => {
        try {
            ...
            localStorage.setItem("SupplyGridData", JSON.stringify(gridData));
    ...
    const handleLoadData = () => {
        try {
            const savedData = localStorage.getItem("SupplyGridData");
            if (savedData) {
